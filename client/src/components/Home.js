    ...
    return (
      <div>
        <div style={{ backgroundImage: "url(https://www.followmeretreat.org/wp-content/uploads/2017/03/cropped-Jesus-Hand-Vanilla-2.jpg)", backgroundRepeat: 'no-repeat', backgroundSize: 'cover', height: "100vh", backgroundColor: "white", backgroundPosition: "center", position: "relative" }}>
          <div style={{textAlign: "center", position: "absolute", top: "25%", left: "20%", color: "white"}}>
            <TextLoop>
          ...
          <Header as='h2' style={{textAlign: "center", position: "absolute", top: "30%", left: "15%", color: "white"}}>To Get Started, Click on the current week below.</Header>
        </div>
        <Grid columns={2}>
          <Grid.Row>
            <Grid.Column>
